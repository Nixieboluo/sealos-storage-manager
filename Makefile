...
web-dev:
	cd $(WEB_DIR) && $(ENCORE_ENV) VITE_API_BASE_URL="$(WEB_DEV_API_BASE_URL)" VITE_DEV_ENABLE_ADMIN_MODE=true VITE_DEV_DISABLE_SEALOS_DESKTOP_SDK=true VITE_DEV_KUBECONFIG="$$(cat $(WEB_DEV_KUBECONFIG))" $(PNPM) dev
